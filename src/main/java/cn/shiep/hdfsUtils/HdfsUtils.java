...
public class HdfsUtils {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // hdfsUtils.deleteDir("/AcWing算法基础课.md");
        // hdfsUtils.copyFromHadoop("/user/TestFile.txt");
        // //测试show功能
        // hdfsUtils.showFromHadoop("/cloudisk/6_12_与自己对话.md");
        /**
         * 权限问题，通过关闭安全模式解决问题
         */
        //测试上传
     ...
     * @param remoteDir
     */
    public void makeDir(String remoteDir) throws IOException {
     ...
     * @return
     */
    public boolean testDir(String path) throws IOException {
        FileSystem fs = FileSystem.get(conf);
        try {
     ...
     * @param remoteDir
     */
    public void lsDir(String remoteDir) throws IOException {
        FileSystem fs = FileSystem.get(conf);
        try {
     ...
     * @throws Exception
     */
    public StringBuilder showFromHadoop(String remoteFilePath) throws IOException {
        FileSystem fs = FileSystem.get(conf);
        remotePath = new Path(remoteFilePath);
     ...
     * @throws Exception
     */
    public void copyFromHadoop(String localFilePath,String remoteFilePath) throws IOException {
     ...
     * @throws Exception
     */
    public void copyToHadoop(String localFilePath,String remoteFilePath) throws IOException {
        FileSystem fs = FileSystem.get(conf);
        remotePath = new Path(remoteFilePath);
        localPath = new Path(localFilePath);
        try {
